...
version: 0.1.0
author: Mibay (Mibayy), Anydeals Agent
license: MIT
...
```
SCRIPT=~/.AnyDeals/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.AnyDeals/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
