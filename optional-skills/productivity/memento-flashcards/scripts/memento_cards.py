...
Data file: $ANYDEALS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ANYDEALS_HOME = Path(os.environ.get("ANYDEALS_HOME", Path.home() / ".AnyDeals"))
DATA_DIR = _ANYDEALS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
