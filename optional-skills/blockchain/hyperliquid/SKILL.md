...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Anydeals Agent
license: MIT
...
The script reads `~/.AnyDeals/.env` for two optional defaults:
...
Helper script: `~/.AnyDeals/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.AnyDeals/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.AnyDeals/.env`.
...
```bash
python3 ~/.AnyDeals/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.AnyDeals/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
