...
Control the user's Spotify account via the Anydeals Spotify toolset (7 tools). Setup guide: https://AnyDeals-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `AnyDeals auth spotify` again.
