...
Built for [Anydeals Agent](https://github.com/NousResearch/AnyDeals-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/AnyDeals-agent/skills/creative/ascii-video`](https://github.com/NousResearch/AnyDeals-agent/tree/main/skills/creative/ascii-video) via PR.
