...
try:
    ...
    _ANYDEALS_VERSION = "0.0.0"

_APP_VERSION = _ANYDEALS_VERSION
_BOT_VERSION = _ANYDEALS_VERSION
_YUANBAO_INSTANCE_ID = str(ANYDEALS_INSTANCE_ID)  # single source: yuanbao_proto.ANYDEALS_INSTANCE_ID
