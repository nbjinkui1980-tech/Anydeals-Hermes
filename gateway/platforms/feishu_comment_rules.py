...
Config: ~/.AnyDeals/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.AnyDeals/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_AnyDeals_home()`` helper (ANYDEALS_HOME-aware and
...
RULES_FILE = get_AnyDeals_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_AnyDeals_home() / "feishu_comment_pairing.json"
