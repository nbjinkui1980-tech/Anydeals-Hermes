...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateAnyDeals: "Update AnyDeals",
    updatingAnyDeals: "Updating AnyDeals…",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.anydeals/skills/",
  ...
  chat: {
    sessionTokenUnavailable:
      "Session token unavailable. Open this page through `anydeals-agent dashboard`, not directly.",
    copyLastAssistant: "Copy last assistant response as raw markdown",
  },
  ...
  plugins: {
    ...
    installBtn: "Install",
    rescanHint: "Rescan detects new plugins already on disk.",
    removeHint: "Remove permanently deletes the plugin from the agent.",
    ...
    removeConfirm: "Remove plugin?",
    dashboardSlots: "Dashboard slots",
    noDashboardTab: "No dashboard tab provided by this plugin.",
  ...
  profiles: {
    ...
    nameRule: "Must be lowercase letters, numbers, hyphens and underscores (max 64 chars)",
    ...
    confirmDeleteMessage: "This permanently removes the \"{name}\" profile and all of its data. This cannot be undone.",
    ...
    rename: "Rename",
    soulSection: "SOUL Section",
    soulPlaceholder: "Enter the SOUL section content...",
    saveSoul: "Save SOUL",
