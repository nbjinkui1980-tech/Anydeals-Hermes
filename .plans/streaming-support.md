# Streaming LLM Response Support for Anydeals Agent
...
```
ANYDEALS_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ANYDEALS_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `AnyDeals_cli/config.py` | 1 | +streaming config defaults |
...
ANYDEALS_STREAMING_ENABLED=true
```
