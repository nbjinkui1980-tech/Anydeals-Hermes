# Anydeals Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.AnyDeals/plugins/AnyDeals-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.AnyDeals/plugins/AnyDeals-achievements/scan_checkpoint.json`.
