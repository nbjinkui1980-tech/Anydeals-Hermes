# Anydeals Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.AnyDeals/plugins/AnyDeals-achievements/state.json` (existing unlock state)
  - `~/.AnyDeals/plugins/AnyDeals-achievements/scan_snapshot.json` (new)
  - `~/.AnyDeals/plugins/AnyDeals-achievements/scan_checkpoint.json` (new)
