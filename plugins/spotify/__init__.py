...
``_check_spotify_available()`` — when the user has not run ``AnyDeals auth
spotify``, the tools remain registered (so they appear in ``AnyDeals
...
The Spotify auth flow (``AnyDeals auth spotify``), CLI plumbing, and docs
