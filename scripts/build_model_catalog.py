#!/usr/bin/env python3
"""Build the Anydeals Model Catalog — a centralized JSON manifest of curated models.
...
Anydeals CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Anydeals release.
...
# Ensure ANYDEALS_HOME is set for imports that touch it at module level.
os.environ.setdefault("ANYDEALS_HOME", os.path.join(os.path.expanduser("~"), ".AnyDeals"))

from AnyDeals_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "AnyDeals-agent repo",
            "docs": "https://AnyDeals-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
