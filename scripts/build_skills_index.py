#!/usr/bin/env python3
"""Build the Anydeals Skills Index — a centralized JSON catalog of all skills.
...
`AnyDeals skills search/install` can use it without hitting the GitHub API.
...
# Ensure ANYDEALS_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Anydeals Skills Index...", flush=True)
