...
VERSION_FILE = REPO_ROOT / "AnyDeals_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "274096618+AnyDeals-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "AnyDeals@nousresearch.com": "NousResearch",
    ...
    "AnyDeals@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "teknium@AnyDeals-agent": "teknium1",
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (ANYDEALS_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (ANYDEALS_HOME inject)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "AnyDeals@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/AnyDeals-agent",
    ...
    lines.append(f"# Anydeals Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Anydeals Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Anydeals Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Anydeals Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Anydeals Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Anydeals Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Anydeals Agent v{new_version} ({calver_date})' "
