...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Anydeals\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "AnyDeals@nousresearch.com",
    "AnyDeals-audit@example.com",
    "AnyDeals@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/AnyDeals-agent",
                "--state", "merged",
