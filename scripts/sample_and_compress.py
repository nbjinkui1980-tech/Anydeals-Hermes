...
DEFAULT_DATASETS = [
    ...
    "NousResearch/AnyDeals-agent-megascience-sft1",
    "NousResearch/Anydeals-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Anydeals-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-AnyDeals-agent"
]
