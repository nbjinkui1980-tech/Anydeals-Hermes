...
DEFAULT_CODEX_MODELS: List[str] = [
    ...
    # in AnyDeals_cli/models.py — only the openai-codex (OAuth) provider
...
def _read_cache_models(codex_home: Path) -> List[str]:
    ...
    if isinstance(entries, list):
        for item in entries:
            ...
            # public OpenAI API, while Anydeals openai-codex talks to the same
