"""
Skills configuration for Anydeals Agent.
`AnyDeals skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.AnyDeals/config.yaml under:
...
from AnyDeals_cli.config import cfg_get, load_config, save_config
from AnyDeals_cli.colors import Colors, color
from AnyDeals_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `AnyDeals skills`."""
    from AnyDeals_cli.curses_ui import curses_checklist
