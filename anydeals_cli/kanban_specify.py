...
Used by ``AnyDeals kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``AnyDeals_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Anydeals Agent board.
...
def _profile_author() -> str:
    """Mirror of ``AnyDeals_cli.kanban._profile_author``. Kept local to
    avoid a circular import when kanban.py imports this module."""
    return (
        os.environ.get("ANYDEALS_PROFILE")
