...
Set your Tenor API key in your environment (add to `~/.AnyDeals/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/AnyDeals-agent/blob/main/skills/media/gif-search/url)`
