...
| Version | `1.1.0` |
| Author | Anydeals Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For Anydeals:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Anydeals tools to understand the project:
