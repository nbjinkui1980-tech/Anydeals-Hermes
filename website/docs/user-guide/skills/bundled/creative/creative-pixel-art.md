...
```python
import sys
sys.path.insert(0, "/home/teknium/.AnyDeals/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.AnyDeals/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Anydeals installs package this)
