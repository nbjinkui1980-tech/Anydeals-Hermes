...
```bash
python3 -m pyfiglet "ANYDEALS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ANYDEALS&font=Slant" | boxes -d stone
```
