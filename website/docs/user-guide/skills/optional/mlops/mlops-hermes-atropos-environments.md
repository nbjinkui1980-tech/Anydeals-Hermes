---
title: "Anydeals Atropos Environments — Build, test, and debug Anydeals Agent RL environments for Atropos training"
sidebar_label: "Anydeals Atropos Environments"
description: "Build, test, and debug Anydeals Agent RL environments for Atropos training"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Anydeals Atropos Environments

Build, test, and debug Anydeals Agent RL environments for Atropos training. Covers the AnydealsAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the AnyDeals-agent repo.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `AnyDeals skills install official/mlops/AnyDeals-atropos-environments` |
| Path | `optional-skills/mlops/AnyDeals-atropos-environments` |
| Version | `1.1.0` |
