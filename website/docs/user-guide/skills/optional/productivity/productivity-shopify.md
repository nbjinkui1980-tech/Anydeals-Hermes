...
| | |
|---|---|
| Source | Optional — install with `AnyDeals skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Anydeals","productType":"Apparel","tags":["test"]}}'
```
