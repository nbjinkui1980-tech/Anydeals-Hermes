...
| | |
|---|---|
| Source | Optional — install with `AnyDeals skills install official/research/qmd` |
...
Anydeals Agent via the native MCP client. This is the preferred
...
Then configure Anydeals Agent to connect via HTTP:
