...
- User wants **Anydeals itself to drive a browser** → use Anydeals' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
