---
sidebar_position: 8
title: "Use Voice Mode with Anydeals"
description: "A practical guide to setting up and using Anydeals voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Anydeals
...
- you want Anydeals sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Anydeals.
...
## Step 1: make sure normal Anydeals works first
...
Anydeals supports both local and cloud speech stacks.
...
4. Anydeals transcribes and responds
...
- asking Anydeals to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Anydeals loop.

## Tuning CLI behavior

### Silence threshold

If Anydeals starts/stops too aggressively, tune:
...
Anydeals stays a normal chat bot, but can speak replies.
...
- you want Anydeals to function like a portable research or ops assistant
...
Anydeals joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Anydeals detects speech boundaries
- transcripts are posted in the associated text channel
- Anydeals responds in text and audio
...
1. get text Anydeals working
2. install `AnyDeals-agent[voice]`
