#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Anydeals docs site.
...
Both publish at:
  https://AnyDeals-agent.nousresearch.com/docs/llms.txt
  https://AnyDeals-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://AnyDeals-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Anydeals as a Python Library", None),
        ("guides/use-mcp-with-AnyDeals", "Use MCP with Anydeals", None),
        ("guides/use-voice-mode-with-AnyDeals", "Use Voice Mode with Anydeals", None),
        ("guides/use-soul-with-AnyDeals", "Use SOUL.md with Anydeals", None),
        ("guides/build-a-AnyDeals-plugin", "Build a Anydeals Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Anydeals"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Anydeals Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by JINKUI. A terminal-native "
    ...
    lines.append(
        ...
        "AnyDeals-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/AnyDeals-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Anydeals Agent — Full Documentation\n",
        (
            "This file is the entire Anydeals Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Anydeals, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://AnyDeals-agent.nousresearch.com/docs\n",
        "Short index: https://AnyDeals-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
