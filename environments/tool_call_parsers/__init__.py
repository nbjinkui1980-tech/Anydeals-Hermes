...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("AnyDeals")
        class AnydealsToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "AnyDeals", "mistral", "llama3_json")
...
from environments.tool_call_parsers.AnyDeals_parser import AnydealsToolCallParser  # noqa: E402, F401
