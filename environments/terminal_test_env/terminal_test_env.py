...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Anydeals Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Anydeals Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Anydeals Agent",
    },
    {
...
class TerminalTestEnv(AnydealsAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/AnyDeals-agent/.env.
        """
