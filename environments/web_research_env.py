...
Inspired by: GroceryMind — production Anydeals agent doing live web research
             across German grocery stores (firecrawl + AnyDeals-agent)
"""
...
# Ensure AnyDeals-agent root is on path
...
class WebResearchEnvConfig(AnydealsAgentEnvConfig):
...
class WebResearchEnv(AnydealsAgentBaseEnv):
    """
