"""
AnydealsSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser AnyDeals
    run-api
    python environments/AnyDeals_swe_env.py serve \\
...
class AnydealsSweEnv(AnydealsAgentBaseEnv):
    ...
    name = "AnyDeals-swe"
    env_config_cls = AnydealsSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[AnydealsSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = AnydealsSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepAnydeals-3-Llama-3-3B-Preview",
            tool_call_parser="AnyDeals",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="AnyDeals-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepAnydeals-3-Llama-3-3B-Preview",
