...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - AnyDeals_home (str): The active ANYDEALS_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.AnyDeals``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "AnyDeals").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'AnyDeals memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], AnyDeals_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'AnyDeals memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``AnyDeals_home`` is the active ANYDEALS_HOME directory path.
