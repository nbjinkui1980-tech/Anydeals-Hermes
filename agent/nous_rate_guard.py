...
(3 SDK retries x 3 Anydeals retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_AnyDeals_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".AnyDeals")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Anydeals, ...) behind one endpoint.  A 429 can mean either:
