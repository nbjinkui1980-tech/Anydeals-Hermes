...
4. Add provider to `AnyDeals tools` picker in `tools_config.py`
...
See `.AnyDeals/plans/2026-05-03-web-tools-provider-architecture.md` for the full UX flow diagram.
