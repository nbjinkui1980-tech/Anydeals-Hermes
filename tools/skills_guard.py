...
Trust levels:
  - builtin:   Ships with Anydeals. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.AnyDeals/\.env|\~/\.AnyDeals/\.env',
     "AnyDeals_env_access", "critical", "exfiltration",
     "directly references Anydeals secrets file"),
    ...
    (r'\.AnyDeals/config\.yaml|\.AnyDeals/SOUL\.md',
     "AnyDeals_config_mod", "critical", "persistence",
     "references Anydeals configuration files directly"),
