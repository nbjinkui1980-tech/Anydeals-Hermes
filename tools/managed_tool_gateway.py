...
def auth_json_path():
    """Return the Anydeals auth store path, respecting ANYDEALS_HOME overrides."""
    return get_AnyDeals_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from AnyDeals_cli.auth import resolve_nous_access_token
