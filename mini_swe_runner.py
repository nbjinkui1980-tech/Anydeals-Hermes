#!/usr/bin/env python3
"""
SWE Runner with Anydeals Trajectory Format

A runner that uses Anydeals-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Anydeals-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Anydeals-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Anydeals format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Anydeals-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Anydeals-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Anydeals Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Anydeals-Agent's built-in execution environments
    and outputs trajectories in Anydeals-Agent format.
    """
    ...
    def _convert_to_AnyDeals_format(
        self,
        ...
        """
        Convert internal message format to Anydeals trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Anydeals trajectory format
        trajectory = self._convert_to_AnyDeals_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Anydeals trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Anydeals Trajectory Format")
    print("=" * 60)
