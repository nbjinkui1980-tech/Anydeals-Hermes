...
def _enable_managed_nous_tools(monkeypatch):
    ...
    AnyDeals_cli.auth and AnyDeals_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("AnyDeals_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("AnyDeals_cli.models.check_nous_free_tier", lambda: False)
