...
import AnyDeals_cli.doctor as doctor
import AnyDeals_cli.gateway as gateway_cli
from AnyDeals_cli import doctor as doctor_mod
from AnyDeals_cli.doctor import _has_provider_env_config
...
class TestDoctorEnvFileEncoding:
    """Regression for #18637 (bug 3): `AnyDeals doctor` crashed on Windows
    ...
    def test_doctor_reads_env_as_utf8_even_when_locale_is_not_utf8(
        ...
        monkeypatch.setattr(doctor_mod, "ANYDEALS_HOME", AnyDeals_home)
...
class TestDoctorToolAvailabilityOverrides:
    ...
    def test_leaves_kanban_unavailable_when_worker_env_is_set(self, monkeypatch):
        monkeypatch.setenv("ANYDEALS_KANBAN_TASK", "probe")
...
def test_run_doctor_sets_interactive_env_for_tool_checks(monkeypatch, tmp_path):
    ...
    def fake_check_tool_availability(*args, **kwargs):
        seen["interactive"] = os.getenv("ANYDEALS_INTERACTIVE")
        raise SystemExit(0)
...
class TestDoctorMemoryProviderSection:
    ...
    def _make_AnyDeals_home(self, tmp_path, provider=""):
        """Create a minimal ANYDEALS_HOME with config.yaml."""
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        home = self._make_AnyDeals_home(tmp_path, provider)
...
def test_run_doctor_accepts_AnyDeals_provider_ids_that_catalog_aliases(
...
class TestGitHubTokenCheck:
    ...
    def test_no_token_and_not_gh_authenticated_shows_warn(self, monkeypatch, tmp_path):
        ...
        from AnyDeals_cli.doctor import run_doctor, _DHH
        import io, contextlib
