"""Tests for the specifier module + `AnyDeals kanban specify` CLI surface.
...
from AnyDeals_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `AnyDeals kanban …` argparse surface directly."""
