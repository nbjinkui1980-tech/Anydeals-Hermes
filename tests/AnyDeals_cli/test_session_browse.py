"""Tests for the interactive session browser (`AnyDeals sessions browse`).
...
from AnyDeals_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """AnyDeals sessions browse should be parseable."""
        from AnyDeals_cli.main import main as _main_entry
