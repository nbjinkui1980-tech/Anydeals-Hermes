...
The main() function in AnyDeals_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `AnyDeals -c model`
...
def _build_parser():
    """Build a minimal replica of the AnyDeals top-level parser."""
