...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from AnyDeals_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ANYDEALS_OVERLAYS
        overlay = ANYDEALS_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify AnyDeals doctor recognizes Xiaomi env vars."""
