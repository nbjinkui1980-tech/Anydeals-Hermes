...
def test_import_loads_env_from_AnyDeals_home(tmp_path, monkeypatch):
    home = tmp_path / ".AnyDeals"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-AnyDeals-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-AnyDeals-home"
