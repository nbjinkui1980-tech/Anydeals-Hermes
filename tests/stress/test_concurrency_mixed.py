...
def worker_loop(worker_id: int, AnyDeals_home: str, result_file: str) -> None:
...
def reclaimer_loop(AnyDeals_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="AnyDeals_mixed_stress_")
    print(f"ANYDEALS_HOME = {home}")
