...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("AnyDeals_cli.config.get_config_path", return_value=config_path), \
             patch("AnyDeals_cli.config.ensure_AnyDeals_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("AnyDeals_cli.config.get_env_path", return_value=env_path), \
             patch("AnyDeals_cli.config.ensure_AnyDeals_home"):
    ...
    def test_ensure_AnyDeals_home_sets_0700(self):
        home = Path(self.tmpdir) / ".AnyDeals"
        with patch("AnyDeals_cli.config.get_AnyDeals_home", return_value=home):
